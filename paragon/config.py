...
PRESTIGE_LINEAR_START_LEVEL = _as_int("PRESTIGE_LINEAR_START_LEVEL", 50)
PRESTIGE_LINEAR_START_MINUTES = _as_float("PRESTIGE_LINEAR_START_MINUTES", 24 * 60.0)
PRESTIGE_LINEAR_MINUTES_PER_LEVEL = _as_float("PRESTIGE_LINEAR_MINUTES_PER_LEVEL", 14.4)
...
ANAGRAM_SOLVE_MAX_PCT = _as_float("ANAGRAM_SOLVE_MAX_PCT", 10.00)
ANAGRAM_SOLVE_MAX_MINUTES = _as_int("ANAGRAM_SOLVE_MAX_MINUTES", 800)
ANAGRAM_FAIL_ADD_PCT = _as_float("ANAGRAM_FAIL_ADD_PCT", 0.10)
ANAGRAM_FAIL_ADD_MINUTES = _as_int("ANAGRAM_FAIL_ADD_MINUTES", 60)
ANAGRAM_FAIL_MAX_PCT = _as_float("ANAGRAM_FAIL_MAX_PCT", 10.00)
ANAGRAM_FAIL_MAX_MINUTES = _as_int("ANAGRAM_FAIL_MAX_MINUTES", 800)
...
# Fishing
FISH_BASE_CHEST_CHANCE = _as_float("FISH_BASE_CHEST_CHANCE", 0.05)
FISH_LOOP_SECONDS = _as_int("FISH_LOOP_SECONDS", 5)
FISH_DOCK_TIMER_STEP_MINUTES = _as_int("FISH_DOCK_TIMER_STEP_MINUTES", 5)
FISH_MIN_BITE_SECONDS = _as_int("FISH_MIN_BITE_SECONDS", 10)
FISH_MAX_BITE_SECONDS = _as_int("FISH_MAX_BITE_SECONDS", 60)
FISH_IDLE_TIMEOUT_SECONDS = _as_int("FISH_IDLE_TIMEOUT_SECONDS", 5 * 60)

# Bounty
BOUNTY_CLAIM_SECONDS = _as_int("BOUNTY_CLAIM_SECONDS", 90)
BOUNTY_STOP_COOLDOWN_SECONDS = _as_int("BOUNTY_STOP_COOLDOWN_SECONDS", 10 * 60)
BOUNTY_SURVIVOR_MIN_EXPOSURE_MINUTES = _as_int("BOUNTY_SURVIVOR_MIN_EXPOSURE_MINUTES", 15)
BOUNTY_SURVIVOR_BASE_MINUTES_EQ = _as_int("BOUNTY_SURVIVOR_BASE_MINUTES_EQ", 90)
BOUNTY_SURVIVOR_PER_EXPOSURE_MINUTES_EQ = _as_float("BOUNTY_SURVIVOR_PER_EXPOSURE_MINUTES_EQ", 4.0)
BOUNTY_SURVIVOR_PER_COMPANION_MINUTES_EQ = _as_float("BOUNTY_SURVIVOR_PER_COMPANION_MINUTES_EQ", 1.5)
BOUNTY_SURVIVOR_MAX_COMPANIONS = _as_int("BOUNTY_SURVIVOR_MAX_COMPANIONS", 3)
BOUNTY_SURVIVOR_MAX_MINUTES_EQ = _as_int("BOUNTY_SURVIVOR_MAX_MINUTES_EQ", 720)
BOUNTY_SURVIVOR_REWARD_MULTIPLIER = _as_float("BOUNTY_SURVIVOR_REWARD_MULTIPLIER", 2)
BOUNTY_CLAIM_BASE_MINUTES_EQ = _as_int("BOUNTY_CLAIM_BASE_MINUTES_EQ", 180)
BOUNTY_CLAIM_REWARD_MULTIPLIER = _as_float("BOUNTY_CLAIM_REWARD_MULTIPLIER", 1.15)
BOUNTY_FAIL_DEBUFF_PCT = _as_float("BOUNTY_FAIL_DEBUFF_PCT", 0.45)
BOUNTY_FAIL_DEBUFF_MINUTES = _as_int("BOUNTY_FAIL_DEBUFF_MINUTES", 240)
...
BOSS_SPAWN_MIN_DAYS = _as_int("BOSS_SPAWN_MIN_DAYS", 1 * 24)
BOSS_SPAWN_MAX_DAYS = _as_int("BOSS_SPAWN_MAX_DAYS", 3 * 24)
...
BOSS_DURATION_MIN_MINUTES = _as_int("BOSS_DURATION_MIN_MINUTES", 60)
BOSS_DURATION_MAX_MINUTES = _as_int("BOSS_DURATION_MAX_MINUTES", 60)
BOSS_ATTACK_COOLDOWN_SECONDS = _as_int("BOSS_ATTACK_COOLDOWN_SECONDS", 75)
BOSS_RES_COOLDOWN_SECONDS = _as_int("BOSS_RES_COOLDOWN_SECONDS", 45)
...
BOSS_HP_BASE = _as_int("BOSS_HP_BASE", 120_000)
BOSS_HP_PER_TARGET_FIGHTER = _as_int("BOSS_HP_PER_TARGET_FIGHTER", 70_000)
BOSS_HP_PER_BOSS_PRESTIGE = _as_int("BOSS_HP_PER_BOSS_PRESTIGE", 10_000)
BOSS_DAMAGE_MIN = _as_int("BOSS_DAMAGE_MIN", 5_000)
BOSS_DAMAGE_MAX = _as_int("BOSS_DAMAGE_MAX", 10_000)
BOSS_DAMAGE_PRESTIGE_STEP = _as_int("BOSS_DAMAGE_PRESTIGE_STEP", 5)
BOSS_DAMAGE_PRESTIGE_BONUS = _as_int("BOSS_DAMAGE_PRESTIGE_BONUS", 1_000)
BOSS_DAMAGE_CRIT_BONUS = _as_int("BOSS_DAMAGE_CRIT_BONUS", 5_000)
BOSS_HEAL_MIN = _as_int("BOSS_HEAL_MIN", 12_000)
BOSS_HEAL_MAX = _as_int("BOSS_HEAL_MAX", 30_000)
...
BOSS_VICTORY_BOOST_PCT = _as_float("BOSS_VICTORY_BOOST_PCT", 0.06)
BOSS_VICTORY_BOOST_MINUTES = _as_int("BOSS_VICTORY_BOOST_MINUTES", 180)
BOSS_FAILURE_DEBUFF_PCT = _as_float("BOSS_FAILURE_DEBUFF_PCT", 0.25)
BOSS_FAILURE_DEBUFF_MINUTES = _as_int("BOSS_FAILURE_DEBUFF_MINUTES", 90)
