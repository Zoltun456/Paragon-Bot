...
HELP_DESCRIPTIONS = {
    ...
    "boss": "Show the current raid boss, HP, timer state, and where the fight is happening.",
    "attack": "Attack the current raid boss from inside its temporary boss channel.",
    "resurrect": "Revive a downed raider in the boss channel so they can attack again.",
